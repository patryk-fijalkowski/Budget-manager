(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(
        ...
        require('deepmerge'),
        require('lodash-es/isPlainObject'),
        require('lodash-es/clone'),
        require('lodash-es/toPath'),
  ...
  isEqual =
    isEqual && isEqual.hasOwnProperty('default') ? isEqual['default'] : isEqual;
  deepmerge =
    deepmerge && deepmerge.hasOwnProperty('default')
      ? deepmerge['default']
      : deepmerge;
  isPlainObject =
  ...
  toPath =
    toPath && toPath.hasOwnProperty('default') ? toPath['default'] : toPath;
  invariant =
    invariant && invariant.hasOwnProperty('default')
      ? invariant['default']
      : invariant;
  hoistNonReactStatics =
    hoistNonReactStatics && hoistNonReactStatics.hasOwnProperty('default')
      ? hoistNonReactStatics['default']
      : hoistNonReactStatics;
  cloneDeep =
    cloneDeep && cloneDeep.hasOwnProperty('default')
      ? cloneDeep['default']
      : cloneDeep;
  ...
  function useFormik(_ref) {
    ...
    var runSingleFieldLevelValidation = React.useCallback(function (
      field,
      value
    ) {
  ...
  function Field(_ref) {
    ...
    }, []); // RegisterForm field and field-level validation with parent <Formik>
        ...
        (function (_React$Component) {
          ...
          function C() {
            ...
            _this.renderFormComponent = function (formikProps) {
              return React.createElement(
                Component,
                Object.assign({}, _this.props, formikProps)
              );
            };
          ...
          _proto.render = function render() {
            ...
            return React.createElement(
              ...
              Object.assign({}, props, config, {
                ...
                validationSchema:
                  config.validationSchema && this.validationSchema,
                ...
                initialTouched:
                  ...
                  config.mapPropsToTouched(this.props),
      ...
      function FieldArrayInner(props) {
        ...
        _this.updateArrayField = function (fn, alterTouched, alterErrors) {
          ...
          setFormikState(function (prevState) {
            ...
            var updateTouched =
              typeof alterTouched === 'function' ? alterTouched : fn; // values fn should be executed before updateErrors and updateTouched,
  ...
  var FastFieldInner =
    ...
    (function (_React$Component) {
      ...
      _proto.componentDidMount = function componentDidMount() {
        // RegisterForm the Field with the parent Formik. Parent will cycle through
