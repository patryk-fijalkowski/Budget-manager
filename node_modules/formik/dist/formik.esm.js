...
function useFormik(_ref) {
  ...
  var runValidateHandler = useCallback(
  ...
  var runValidationSchema = useCallback(
    function (values, field) {
  ...
  var runFieldLevelValidations = useCallback(
    function (values) {
  ...
  var runAllValidations = useCallback(
    function (values) {
      return Promise.all([
...
function Formik(props) {
  ...
  return createElement(
    ...
    component
      ? createElement(component, formikbag)
      : render
      ? render(formikbag)
...
function withFormik(_ref) {
  ...
  return function createFormik(Component$1) {
    ...
    return hoistNonReactStatics(
      C,
      Component$1 // cast type to ComponentClass (even if SFC)
    );
  };
}
